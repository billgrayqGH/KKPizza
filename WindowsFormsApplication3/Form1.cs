...
namespace WindowsFormsApplication3
{
    public partial class Form1 : Form
    {
        ...
        {
           DialogResult dialog = MessageBox.Show("Thanks for ordering at Krusty Krab Pizza. Your Pizza will be ready and delivered in 30 minutes. Do you want to order again?", "Exit", MessageBoxButtons.YesNo);
